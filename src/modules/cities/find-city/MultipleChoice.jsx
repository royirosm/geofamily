// src/modules/cities/find-city/MultipleChoice.jsx
    ...
    return (
      <div className="flex flex-col items-center gap-3">
        ...
        <div className="flex flex-col items-center gap-1">
          <h2 className={`font-extrabold text-gray-800 text-center ${isKids ? 'text-2xl' : 'text-xl'}`}>
            {country.name[lang] || country.name.en}
          </h2>
          <p className="text-gray-400 text-sm font-medium">🏙️ Name a major city in this country</p>
        </div>
      </div>
    )
  },
